		...
		It("disseminates private data per collections_config1 (positive test) and collections_config8 (negative test)", func() {
			...
			testChaincode := chaincode{
				Chaincode: nwo.Chaincode{
					Name:    "marblesp",
					Version: "1.0",
					Path:    "github.com/Randyshu2018/fabric/integration/chaincode/marbles_private/cmd",
					Ctor:    `{"Args":["init"]}`,
	...
	Describe("Pvtdata behavior with untouched peer configs", func() {
		...
		BeforeEach(func() {
			...
			newLifecycleChaincode = nwo.Chaincode{
				Name:              "marblesp",
				Version:           "1.0",
				Path:              components.Build("github.com/Randyshu2018/fabric/integration/chaincode/marbles_private/cmd"),
				Lang:              "binary",
