...
import (
	...
	"github.com/Randyshu2018/fabric/integration/chaincode/kvexecutor"
	...
	BeforeEach(func() {
		...
		testChaincode = chaincode{
			Chaincode: nwo.Chaincode{
				Name:        "kvexecutor",
				Version:     "1.0",
				Path:        components.Build("github.com/Randyshu2018/fabric/integration/chaincode/kvexecutor/cmd"),
				Lang:        "binary",
