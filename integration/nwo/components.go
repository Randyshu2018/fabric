...
func (c *Components) ConfigTxGen() string {
	return c.Build("github.com/Randyshu2018/fabric/cmd/configtxgen")
}

func (c *Components) Cryptogen() string {
	return c.Build("github.com/Randyshu2018/fabric/cmd/cryptogen")
}

func (c *Components) Discover() string {
	return c.Build("github.com/Randyshu2018/fabric/cmd/discover")
}

func (c *Components) Idemixgen() string {
	return c.Build("github.com/Randyshu2018/fabric/cmd/idemixgen")
}

func (c *Components) Orderer() string {
	return c.Build("github.com/Randyshu2018/fabric/cmd/orderer")
}

func (c *Components) Peer() string {
	return c.Build("github.com/Randyshu2018/fabric/cmd/peer")
}
